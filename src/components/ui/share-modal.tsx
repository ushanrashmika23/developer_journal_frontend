...
const GmailLogo = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="#DC2626" stroke="#DC2626" strokeWidth="0.5">
        {/* Envelope body */}
        <rect x="1" y="4" width="22" height="16" rx="2" ry="2" fill="#fff" stroke="#B91C1C" strokeWidth="2"/>
        {/* Envelope flap */}
        <path d="M1 6l11 8 11-8" fill="none" stroke="#B91C1C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-background border border-border rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
                ...
                <div className="flex items-center justify-center p-6 border-b border-border">
                    <h2 className="text-xl font-semibold text-foreground">Share this post</h2>
                    {/* <Button
            variant="ghost"
            size="sm"
            onClick={onClose}
